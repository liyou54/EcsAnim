...
namespace Anim.RuntimeImage
{
    ...
    public partial class CharacterRenderSys : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            {
                var renderJobQueryCreate = GetEntityQuery(ComponentType.ReadWrite<CharacterRenderIdComponent>(), ComponentType.ReadWrite<CharacterRenderStateComp>());
                var renderJobQueryDel = GetEntityQuery(ComponentType.ReadWrite<CharacterRenderIdComponent>(), ComponentType.ReadWrite<CharacterRenderStateComp>());
